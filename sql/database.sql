...
select groups.name, permissions.name, groups_permissions.group_id, groups_permissions.permission_id from groups_permissions inner join `groups` on groups_permissions.group_id = `groups`.id inner join permissions on groups_permissions.permission_id = permissions.id;