...
create view group_permission_view as select `groups`.name as group_name, permissions.name as permission_name, groups_permissions.group_id, groups_permissions.permission_id from groups_permissions inner join `groups` on groups_permissions.group_id = `groups`.id inner join permissions on groups_permissions.permission_id = permissions.id;
