...
public class ProductDao {
    ...
    // queries
    public static final String CHECK_IF_PRODUCT_EXISTS = "SELECT * FROM " + TABLE_PRODUCTS + " WHERE "
            + COLUMN_PRODUCT_NAME + " = ?";
    public static final String QUERY_VIEW_STOCK_LIST = "SELECT * FROM " + VIEW_STOCK_LIST;
    public static final String INSERT_PRODUCTS = "INSERT INTO " + TABLE_PRODUCTS + " (" + COLUMN_PRODUCT_NAME + ", "
            + COLUMN_PRODUCT_DESCRIPTION + ", " + COLUMN_PRODUCT_ADDED_BY + ", " + COLUMN_PRODUCT_IMAGE
            + ") VALUES (?,?,?,?)";
    public static final String INSERT_STOCK = "INSERT INTO " + TABLE_STOCK + " (" + COLUMN_STOCK_PRODUCT_ID + ", "
            + COLUMN_STOCK_QUANTITY + ", " + COLUMN_STOCK_BUYING_PRICE + ", " + COLUMN_STOCK_COLOR + ", "
            + COLUMN_STOCK_SIZE + ", " + COLUMN_STOCK_ADDED_BY + ") VALUES (?,?,?,?,?,?)";
    ...
    public static final int JAN_STOCK = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int MAR_STOCK = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int MAY_STOCK = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int JUL_STOCK = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int SEP_STOCK = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int NOV_STOCK = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int JAN = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int MAR = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int MAY = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int JUL = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int SEP = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    public static final int NOV = " SELECT COUNT(*) FROM" + TABLE_TRANSACTIONS + " =?";
    ...
    public int createProduct(Product product) throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            if (results.next()) {
                ...
                PreparedStatement insert_products = conn.prepareStatement(INSERT_PRODUCTS,
